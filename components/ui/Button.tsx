...
export const buttonVariants = cva(
  'eq inline-block text-center whitespace-nowrap px-3 py-1 border rounded-md text-lg capitalize disabled:bg-gray disabled:text-black disabled:cursor-default disable:border-gray',
  {
    variants: {
      variant: {
        primary:
